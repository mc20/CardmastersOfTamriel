...
public class Rule
{
    ...
    public Assign Assign { get; set; } = new();
}

public class Match
{
    [JsonPropertyName("formType")]
    public string FormType { get; set; } = "MiscItem";
...
public class Assign
{
    ...
    [JsonPropertyName("subTypeDisplay")]
    public string SubTypeDisplay { get; set; } = string.Empty;
}
